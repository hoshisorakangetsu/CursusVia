        ...
        <div class="modal">
            ...
            <div class="modal-content">
                ...
                <div class="detail-item">
                    ...
                    <span class="litAvaiBalance">
                        <asp:Literal ID="litAvaiBalance" runat="server" Text="RM 1,000"></asp:Literal></span>
                </div>
                <div class="detail-item">
                    <asp:Label ID="Label2" runat="server" Text="Withdraw Amount:"></asp:Label>
                    <span class="litAvaiBalance">
                        <asp:Literal ID="Literal2" runat="server" Text="RM 1,000"></asp:Literal></span>
                </div>

                <div class="detail-item">
                    <asp:Label ID="Label3" runat="server" Text="Bank name:"></asp:Label>
                    <span class="status pending">
                        <asp:Literal ID="Literal3" runat="server" Text="RHB"></asp:Literal></span>
                </div>
                <div class="detail-item">
                    <asp:Label ID="Label4" runat="server" Text="Bank Account:"></asp:Label>
                    <span class="status pending">
                        <asp:Literal ID="Literal4" runat="server" Text="121551550052"></asp:Literal></span>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                    ...
                    <asp:Literal ID="Literal7" runat="server" Text="NA"></asp:Literal>
