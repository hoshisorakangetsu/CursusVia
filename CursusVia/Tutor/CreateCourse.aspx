...
<asp:Content ID="Content2" ContentPlaceHolderID="TutorMasterBody" runat="server">
    <div class="createUpdateCourseMain">
        ...
        <uc:FileUploadWithPreview runat="server" ID="FileUploadWithPreview" IsRequired="true" />
        <div class="fields">
            <div class="genericInputField">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="CourseTitle" CssClass="validationMessage"></asp:RequiredFieldValidator>
            </div>
            <div class="genericInputField">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="Price" CssClass="validationMessage"></asp:RequiredFieldValidator>
            </div>
            <div class="genericInputField">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="CourseCategory" CssClass="validationMessage"></asp:RequiredFieldValidator>
            </div>
            <div class="genericInputField">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="Description" CssClass="validationMessage"></asp:RequiredFieldValidator>
            </div>
        </div>
